    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-12">
        ...
        <div class="panel-body container col-md-12" style="text-align: left; ">
            ...
            <a role="link" class="btn btn-primary"  href="/admin/product_category/create/" >
            ...
            @foreach ($categories as $category)
              <tr id="tr_{{ $category->id }}" role="row">
                ...
                <td style="text-align=center; width:auto;">
                  ...
                  @else
                    class="btn btn-xs btn-primary edit"
                  @endif href="/admin/product_category/{{ $category->id }}/">
                ...
                <td style="text-align: center; width:auto;">
                                        <a href="/admin/product_category/{{ $category->id }}/edit/"
                                            @if ($category->trashed())
                                              class="form-control" disabled
                                            @else
                                              class="btn btn-xs btn-primary edit"
                    ...
                    if(check == true) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                              window.location.replace("/admin/product_category/");
                                // if (data['success']) {
                                //     // $(".sub_chk:checked").each(function() {
