    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-12">
        ...
        <div class="panel-body container col-md-12" style="text-align: left; ">
            ...
            <a role="link" class="btn btn-primary"  href="/admin/products/create/" >
                ...
                <button style="margin-bottom: 10px" class="btn btn-danger delete_all" data-url="/admin/products/myProductDeleteAll">Delete All Selected</button>
        </div>
          ...
          <tbody>
            ...
            @foreach ($products as $product)
              <tr id="tr_{{ $product->id }}" role="row">
                ...
                <td>
                  @if ($product->shw  == 'Y')
                    <button style="background-color: #00913B;" type="button" title="Draft" class="btn btn-success" onclick="window.location.replace('/admin/products/{{ $product->id }}/disable')" class="btn btn-xs btn-primary edit">
                      Published
                  ...
                  @else
                    <button type="button" title="Enable" class="btn btn-outline-danger" onclick="window.location.replace('/admin/products/{{ $product->id }}/enable')" class="btn btn-xs btn-primary edit" >
                ...
                <td style="text-align=center; width:auto;">
                  <a class="btn btn-xs btn-primary edit" href="/admin/products/{{ $product->id }}/">
                ...
                <td style="text-align: center; width:auto;">
                                        ...
                                        <a href="/admin/products/{{ $product->id }}/edit/" class="btn btn-xs btn-primary edit" id="{{ $product->id }}">
                                ...
                                <td style="text-align: center; width:auto;">
                                      ...
                                      <a onclick="return confirm('Are you sure you want to delete?')" href="/admin/products/{{ $product->id }}/delete" class="btn btn-xs btn-danger delete" id="{{ $product->id }}">
