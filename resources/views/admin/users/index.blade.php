...
<div class="container">
    <div class="row justify-content-center">
      ...
      <div class="panel-body container col-md-12" style="text-align: left; ">
            <a role="link" class="btn btn-primary"  href="/admin/user/create/">
              ...
              <button style="margin-bottom: 10px" class="btn btn-danger delete_all" data-url="/admin/user/myUserDeleteAll">Delete All Selected</button>
        </div>
              ...
              <thead class="thead-light">
                  <tr>
                    <th width="50px"><input type="checkbox" id="master"></th>
                      ...
                      <th >@sortablelink('Creation Date')</th>
                      <th colspan="3" style="text-align: center;">Operations</th>
                        ...
                        <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="card-body">{{ $user->updated_at }}</td>
                                  <td style="text-align=center; width:auto;">
                                    ...
                                    <td style="text-align: center; width:auto;">
                                       <a class="btn btn-primary" href="/admin/user/{{$user->id}}/edit">
                                     ...
                                     <td style="text-align: center; width:auto;">
                                       <a onclick="return confirm('Are you sure you want to delete?')" href="/admin/user/{{ $user->id }}/delete" class="btn btn-xs btn-danger delete" id="{{ $user->id }}">
