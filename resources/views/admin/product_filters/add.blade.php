    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading main-color-bg">
          <h2 class="panel-title">{{ __('Add a product search filter') }}</h2>
        </div>
      </div>
    </div>
    <div class="well">
      <!-- if there are creation errors, they will show here -->
      <form method="POST" action="/manage/product_index" class="form-horizontal">
      @csrf
        <div style="width: 90%;" class="row">
          <div class="col-12 col-xl-8 col-lg-8 col-md-8">
            <div class="mb-3">
              ...
              <textarea name="desc" id="desc"  rows="10" cols="80" class="form-control" ></textarea>
            </div>
          </div>
